...
ifeq ($(NDK_DEBUG),1)
PLT_PREBUILT_PATH := $(LOCAL_PATH)/PlatinumKit/Platinum/Build/Targets/arm-android-linux/Debug
else
PLT_PREBUILT_PATH := $(LOCAL_PATH)/PlatinumKit/Platinum/Build/Targets/arm-android-linux/Release
endif

include $(CLEAR_VARS)
LOCAL_MODULE := Platinum
$(info $(PLT_PREBUILT_PATH))
...
LOCAL_EXPORT_C_INCLUDES += $(PLT_ROOT)/PlatinumKit/Neptune/Source/Core
include $(PREBUILT_STATIC_LIBRARY)
